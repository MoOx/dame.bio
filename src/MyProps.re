...
let extendView =
  ...
  MyUtilsRN.objAssign2(
    Js.Undefined.{
      ...
      "collapsable":
        fromOption(MyUtilsRN.optBoolToOptJsBoolean(collapsable)),
      "importantForAccessibility":
        fromOption(
          MyUtilsRN.option_map(
            prop =>
          ...
          MyUtilsRN.option_map(
            traits => {
              let to_string =
                ...
                | `pageTurn => "pageTurn";
              traits -> Belt.List.map(to_string) |> Belt.List.toArray;
            },
            accessibilityTraits,
          ),
        ),
      "accessibilityViewIsModal":
        fromOption(
          MyUtilsRN.optBoolToOptJsBoolean(accessibilityViewIsModal),
        ),
      "shouldRasterizeIOS":
